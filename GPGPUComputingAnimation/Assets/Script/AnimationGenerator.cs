...
{
    public string animationPath = "Assets/Texture/VTexture";
    public string animationName = "Mesh_Anim";
    public float animationFPS = 24;
    public SkinnedMeshRenderer skinMeshRender;
    public Animation animation;

    private Mesh bakedMesh;
    [MenuItem("Window/Generate Curve")]
    ...
    {
        Transform parent = skinMeshRender.transform;
        animation.Play();
